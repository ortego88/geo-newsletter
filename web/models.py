...
AVAILABLE_ASSETS = [
    ...
    # ── IBEX 35 — empresas ───────────────────────────────────────────────────
    {"symbol": "ACS", "name": "ACS Actividades", "icon": ""},
    {"symbol": "ACX", "name": "Acerinox", "icon": ""},
    {"symbol": "AENA", "name": "AENA", "icon": ""},
    ...
    {"symbol": "IAG", "name": "IAG (Iberia / British Airways)", "icon": ""},
    ...
    {"symbol": "SGRE", "name": "Siemens Gamesa", "icon": ""},
