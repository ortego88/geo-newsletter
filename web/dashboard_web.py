...
def settings():
    ...
    if request.method == "POST":
        ...
        if max_assets != -1 and len(selected_assets) > max_assets:
            ...
            if assets_changed:
                # Verificar último cambio (solo si la columna existe)
                try:
                    with get_conn() as conn:
                    ...
                    # Si la columna no existe, permitir el cambio
                    pass
            ...
            with get_conn() as conn:
                # Si cambió activos, actualizar timestamp (si la columna existe)
                if assets_changed:
                    try:
                        conn.execute(
                        ...
                        # Si la columna no existe, solo actualizar activos
                        conn.execute(
    ...
    try:
        ...
        # Si la columna no existe todavía, no hay bloqueo
        is_locked_for_changes = False
...
_TV_SYMBOLS = {
    ...
    "DOGE": "BINANCE:DOGEUSDT", "TRX": "BINANCE:TRXUSDT", "TON": "OKX:TONUSDT",
    "LINK": "BINANCE:LINKUSDT", "AVAX": "BINANCE:AVAXUSDT", "SHIB": "BINANCE:SHIBUSDT",
    "DOT": "BINANCE:DOTUSDT", "SUI": "BINANCE:SUIUSDT", "LTC": "BINANCE:LTCUSDT",
    "HBAR": "BINANCE:HBARUSDT", "UNI": "BINANCE:UNIUSDT", "ATOM": "BINANCE:ATOMUSDT",
    "XLM": "BINANCE:XLMUSDT", "NEAR": "BINANCE:NEARUSDT",
    # Layer 2 & Infra
    "ARB": "BINANCE:ARBUSDT", "OP": "BINANCE:OPUSDT", "MATIC": "BINANCE:MATICUSDT",
    "ICP": "BINANCE:ICPUSDT", "FIL": "BINANCE:FILUSDT", "IMX": "BINANCE:IMXUSDT",
    "STX": "BINANCE:STXUSDT", "MNT": "BINANCE:MNTUSDT",
    # DeFi
    "AAVE": "BINANCE:AAVEUSDT", "MKR": "BINANCE:MKRUSDT", "CRV": "BINANCE:CRVUSDT",
    "LDO": "BINANCE:LDOUSDT", "DYDX": "BINANCE:DYDXUSDT", "SNX": "BINANCE:SNXUSDT",
    "PENDLE": "BINANCE:PENDLEUSDT", "JUPITER": "BINANCE:JUPUSDT",
    # AI & Data
    "FET": "BINANCE:FETUSDT", "RENDER": "BINANCE:RENDERUSDT", "INJ": "BINANCE:INJUSDT",
    "TAO": "BINANCE:TAOUSDT", "ONDO": "BINANCE:ONDOUSDT", "AIOZ": "BINANCE:AIOZUSDT",
    # Gaming & Metaverse
    "AXS": "BINANCE:AXSUSDT", "SAND": "BINANCE:SANDUSDT", "MANA": "BINANCE:MANAUSDT",
    "GALA": "BINANCE:GALAUSDT", "ENJ": "BINANCE:ENJUSDT",
    # New L1s
    "APT": "BINANCE:APTUSDT", "SEI": "BINANCE:SEIUSDT", "TIA": "BINANCE:TIAUSDT",
    "KAS": "BINANCE:KASUSDT", "ALGO": "BINANCE:ALGOUSDT",
    # Memecoins
    "PEPE": "BINANCE:PEPEUSDT", "WIF": "BINANCE:WIFUSDT", "FLOKI": "BINANCE:FLOKIUSDT",
    "BONK": "BINANCE:BONKUSDT",
    # Exchange tokens
    "CRO": "BINANCE:CROUSDT", "OKB": "OKX:OKBUSDT", "GT": "GATEIO:GTUSDT",
    # Otros
    "VET": "BINANCE:VETUSDT", "THETA": "BINANCE:THETAUSDT", "FTM": "BINANCE:FTMUSDT",
    "EOS": "BINANCE:EOSUSDT", "RUNE": "BINANCE:RUNEUSDT", "GRT": "BINANCE:GRTUSDT",
}
